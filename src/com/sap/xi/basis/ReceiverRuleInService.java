 ...
 *
 */
@WebServiceClient(name = "ReceiverRuleInService", targetNamespace = "http://sap.com/xi/BASIS", wsdlLocation = "ReceiverRuleInImplBean.wsdl")
    ...
    static {
        ...
        try {
			java.net.URL tmpUrl = IntegratedConfigurationInService.class.getClassLoader()
					.getResource("ReceiverRuleInImplBean.wsdl");
