...
/**
 * <p>Java class for ReceiverRuleOpenForEditOut complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReceiverRuleOpenForEditOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListID" minOccurs="0"/>
 *         &lt;element name="ReceiverRule" type="{http://sap.com/xi/BASIS}ReceiverRule" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ReceiverRuleOpenForEditOut", propOrder = {
    "changeListID",
    "receiverRule",
    "logMessageCollection"
})
public class ReceiverRuleOpenForEditOut {

    @XmlElement(name = "ChangeListID")
    protected ChangeListID changeListID;
    @XmlElement(name = "ReceiverRule")
    protected List<ReceiverRule> receiverRule;
     ...
     * 
     */
    public List<ReceiverRule> getReceiverRule() {
        if (receiverRule == null) {
            receiverRule = new ArrayList<ReceiverRule>();
        }
